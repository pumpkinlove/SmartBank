...
@ContentView(R.layout.activity_emqttd_config)
public class EmqttdConfigActivity extends BaseActivity {
...
//                retrifitTest(view);
    ...
    private void test(final View view,String url){
        ...
        RequestParams params = new RequestParams("http://" + config.getHttpIp() + ":" + config.getHttpPort() + url);
