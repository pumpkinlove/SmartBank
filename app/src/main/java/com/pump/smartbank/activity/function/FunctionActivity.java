...
public class FunctionActivity extends AppCompatActivity {
    ...
    @Event(value={R.id.fun_bankdoing,R.id.fun_ciips,R.id.fun_analyze,R.id.fun_team,R.id.fun_myhelp,R.id.fun_product},type=View.OnClickListener.class)
